...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const lbDatasets = {
      weekly: [
        { rank: 1, name: "Sarah Wijaya", time: 785 },
        { rank: 2, name: "Budi Santoso", time: 742 },
        { rank: 3, name: "Reza Rahadian", time: 695 },
        { rank: 4, name: "Nabil Kurniawan", time: 630, isCurrentUser: true },
        { rank: 5, name: "Alex Chen", time: 580 },
        { rank: 6, name: "Dina Fitri", time: 540 },
        { rank: 7, name: "Ahmad Fauzi", time: 510 },
        { rank: 8, name: "Rina Kusuma", time: 480 },
        { rank: 9, name: "Jessica Lin", time: 420 },
        { rank: 10, name: "Kevin Julio", time: 380 }
      ],
      monthly: [
        { rank: 1, name: "Alex Chen", time: 2850 },
        { rank: 2, name: "Sarah Wijaya", time: 2740 },
        { rank: 3, name: "Budi Santoso", time: 2610 },
        { rank: 4, name: "Jessica Lin", time: 2450 },
        { rank: 5, name: "Nabil Kurniawan", time: 630, isCurrentUser: true }, // Updated as requested
        { rank: 6, name: "Kevin Julio", time: 2180 },
        { rank: 7, name: "Dina Fitri", time: 2050 },
        { rank: 8, name: "Rina Kusuma", time: 1920 },
        { rank: 9, name: "Ahmad Fauzi", time: 1840 },
        { rank: 10, name: "Reza Rahadian", time: 1760 }
      ]
    };
            ...
            if (rankZone) {
                ...
                if (datasetKey === 'weekly') {
                    if (currentUser.rank <= 5) {
                        rankZone.textContent = '▲ Promosi';
                        rankZone.classList.add('zone--up');
                    } else if (currentUser.rank >= 16) {
                        rankZone.textContent = '▼ Degradasi';
